    ...
    <?php if (get_post(3019) || is_checkout()) { ?>
        <div id="popup-date" class="popup date">
            <div class="popup__window select_date">
                <div class="top">
                    <h3> <?php if ($language == 'en') {
                                echo 'Choose The Date';
                            } else {
                                echo 'اختار تاريخ الاستلام';
                            } ?> </h3>
                ...
                <form class="section_content" method="post">
                    ...
                    <div class="section_time">
                        <h3 class="section_title"> <?php if ($language == 'en') {
                                                        echo 'Time';
                                                    } else {
                                                        echo ' الوقت';
                                                    } ?></h3>
                        <div class="options time_option">
                            <div class="s_option">
                                <select class="s_time" name="time" id="time_option">
                                    <option value="false" disabled> <?php if ($language == 'en') {
                                                                        echo 'choose Time';
                                                                    } else {
                                                                        echo ' اختر الوقت';
                                                                    } ?> </option>
                    ...
                    <div class="section_next_pop">
                        <div class="next">
                            <button type="button" id="add_custom_cake_to_cart" class="btn_add_cart disabled"> <?php if ($language == 'en') {
                                                                                                                    echo 'Add To Cart';
                                                                                                                } else {
                                                                                                                    echo 'اتمام الطلب';
                                                                                                                } ?> </button>
        ...
        <div class="popup__window promocode">
            ...
            <div class="section_content">
                ...
                <form class="section_form" action="">
                    <div class="top">
                        <h3> <?php if ($language == 'en') {
                                    echo 'Subscribe to us and get 10% off your first order';
                                } else {
                                    echo 'اشترك معنا لدينا واحصل على خصم 10٪ على طلبك الأول';
                                } ?> </h3>
                        <button type="button" class="popup__close material-icons js-popup-closer">close</button>
                    </div>
                    <div class="s_field half_full">
                        <label for=""><?php if ($language == 'en') {
                                            echo 'First Name';
                                        } else {
                                            echo 'الاسم الاول';
                                        } ?><span>*</span></label>
                    ...
                    <div class="section_bottom">
                        <div class="s_field checkbox">
                            ...
                            <label for="agree"> <?php if ($language == 'en') {
                                                    echo 'I agree to the Privacy Policy and Terms of Service.';
                                                } else {
                                                    echo 'بالاشتراك ، أوافق على سياسة الخصوصية وشروط الخدمة.';
                                                } ?> </label>
                        </div>
                        <div class="button">
