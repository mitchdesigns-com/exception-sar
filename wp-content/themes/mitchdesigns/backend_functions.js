          ...
          if(data.status == 'success'){
            ...
            if(data.code == 401){
              ...
              if(msg.includes("minimum spend")){
                if(current_lang == 'ar'){
                  $('#message-fail').html("الحد الأدنى للإنفاق لهذه القسيمة هو 500 ر.س");
                }else{
                  $('#message-fail').html("The minimum spend for this coupon 500 SAR");
                }
...
//           $('#message_fields').show();
//           let message_points = 'Use Your Current Points Balance Of ' + data.total_points + ' Points To Save ' + data.total_cash + ' SAR';
