        ...
        <div class="left">
            <p class="title woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received ">
                <?php echo apply_filters('woocommerce_thankyou_order_received_text', esc_html__(thankyou_translate('thanks_title', $language), 'woocommerce'), $order); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
						?>
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/thanks_icon.png" alt=""
                    width="40" height="40">
            </p>
            ...
            <p class="desc woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
                <?php 
						$translated_text = thankyou_translate('thanks_contact', $language);
						$formatted_text = preg_replace(
							'/(\+\d{10})/',
							'<span dir="ltr">$1</span>',
							$translated_text
						);
						echo apply_filters('woocommerce_thankyou_order_received_text', $formatted_text, $order);
						?>
            </p>
                ...
                <div class="first">
                    ...
                    <div>
                        <div class="row half">
                            ...
                            <p>
                                <?php if ($language == 'en') {
												$steet_info = get_gov_by_name($order->get_billing_state());
												echo $steet_info->gov_name_en;
											} else {
                        ...
                        <div class="row half">
                            ...
                            <p>
                                <?php if ($language == 'en') {
												$steet_info = get_area_by_name($order->get_meta('_billing_street'));
												echo $steet_info->area_name_en;
											} else {
												echo $order->get_meta('_billing_street');
											} ?>
                            </p>
                        </div>
                        <div class="row half">
                            ...
                            <p>
                                <?php if ($language == 'en') {
												$steet_info = MD_Get_street_rate_by_name_ar($order->get_billing_city());
												echo $steet_info->street_name_en;
											} else {
                    ...
                    <div>
                        <div class="row full">
                            ...
                            <p>
                                <?php if ($order->get_meta('_billing_delivery_date') == 'today') {
												if ($language == 'en') {
													echo 'today';
												} else {
													echo 'اليوم';
												...
												echo $order->get_meta('_billing_delivery_date');
											} ?>
                            </p>
                        </div>
                    </div>
                                            ...
                                            <div class="right">
                                                ...
                                                <ul class="variations">
                                                    ...
                                                    <?php
																	...
																	?>
                                                    <li> <?php if ($language == 'en') {
																					echo $attribute_english;
																				} else {
																					echo $attribute_arabic;
																				}  ?>
                                                    </li>
                            ...
                            <tr class="order-total">
                                <th>
                                    <?php if ($language == 'en') {
													...
													echo 'المطلوب دفعه عند الاستلام ';
												} ?>
                                </th>
