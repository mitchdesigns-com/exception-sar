...
<div class="checkout-content">
	<div class="page-title">
		<h1> <?php if ($language == 'en') {
					echo 'Safe Checkout';
				} else {
					echo 'إتمام عملية الشراء بأمان';
				} ?></h1>
				...
				<div class="checkout-login-tabs">
					<div class="rows">
						<div class="row guest">
							<!-- <div class="icon">
								<img src="<?php //echo get_stylesheet_directory_uri(); 
											?>/assets/img/icons/users-avatar-user-profile-female.png" alt="icon">
							</div> -->
							<div class="content">
								<p>تسوق بدون تسجيل</p>
								<span>تسوق سريع</span>
						...
						<div class="row login trig-signup">
							<!-- <div class="icon">
								<img src="<?php //echo get_stylesheet_directory_uri(); 
											?>/assets/img/icons/sports-and-fitness-badge-reward-medal.png" alt="icon">
							</div> -->
							<div class="content">
								<p>تسجيل حساب جديد</p>
				...
				<div class="order-title">
					...
					<div class="left">
						<a href="<?php echo wc_get_cart_url();
									echo ($language == 'en') ? '?lang=en' : ''; ?>" target="" class="btn"><?php echo  cart_page('edit', $language); ?> </a>
