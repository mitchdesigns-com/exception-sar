                ...
                <div class="dashbord">
                    <div class="my-wallet">
                        ...
                        <div class="points section">
                            ...
                            <div class="right">
                                <div class="title">
                                    <h4><?php echo $user_balance ?> Points <span>(<?php echo $user_cash?> SAR)</span></h4>
                        ...
                        <div class="boxes section">
                            ...
                            <div class="single-box">
                                ...
                                <span>  1 SAR /  <?php   echo  $points_settings['groups'][$user_points_info->level_number]['currency_to_points'] ?> Points </span>
                            </div>
                            <div class="single-box">
