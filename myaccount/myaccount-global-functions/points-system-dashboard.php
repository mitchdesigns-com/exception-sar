...
function Admin_points_controller_callback() { 
    ...
    if(isset($_GET['user_id']) && $_GET['user_id'] != 0){
        ...
        echo '<td style="padding: 0 20px;" >' . number_format( $user_points_info->current_cash  ). ' SAR </td>';
        echo '<td style="padding: 0 20px;" >' . number_format( $user_points_info->total_money ). ' SAR </td>';
        echo '</tr>';
        echo '</table>';
        ?>
        <div class="class-info">
            ...
            <tr>
                <th> Class Name  </th>
                <th>Start From [SAR]</th> 
                <th> 1 SAR To X Points [Gain]</th>
                <th> X Points to SAR [Redeem]</th>
            </tr>
            <tr>
                <td style="padding: 0 60px;" > <?php echo ucfirst($points_settings['groups'][$user_points_info->level_number ]['level_name'] );  ?>  </td>
                <td style="padding: 0 60px;" > <?php echo $points_settings['groups'][$user_points_info->level_number ]['start_from'] ?>  SAR  </td>
                <td style="padding: 0 60px;" > <?php echo $points_settings['groups'][$user_points_info->level_number ]['currency_to_points'] ?> Points  </td>
                <td style="padding: 0 60px;" > <?php echo $points_settings['groups'][$user_points_info->level_number ]['points_to_currency'] ?> SAR  </td>
            </tr>
            </table>
